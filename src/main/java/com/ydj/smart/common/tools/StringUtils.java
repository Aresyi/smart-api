...
public class StringUtils {
	...
	public static void main(String[] args) {
		System.out.println(CommonUtils
				.encodePassword("frank9201061frank9201061frank920"));
		System.out.println(CommonUtils.encodePassword(
				"frank9201061frank9201061frank920").length());

		long current = System.currentTimeMillis();

		String x = StringUtils.base64Encode(StringUtils.base32Encrypt(current));
		System.out.println(StringUtils.base64Encode(StringUtils
				.base32Encrypt(current)));
		System.out.println(current);
		System.out.println(x);
		System.out.println(StringUtils.base32Decrypt(StringUtils
				.base64Decode(x)));
