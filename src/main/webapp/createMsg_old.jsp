...
<div class="container">
    <div class="page">
        <div class="page-inner" id="page-doc-new">
            <div class="doc-wrap">
                <form class="form form-edit-doc" action="/smart-api/message/addMsg" method="post" >

	<input type="hidden" name="markdown" id="is-markdown" value="${empty markdown ? 0 : 1}" />
	<input type="hidden" name="is_html" id="is_html" value="1" />

	<div class="form-item doc-title-wrap">
		<div class="form-field">
			<input name="doc_title" class="doc-title" placeholder="文档标题" />
		</div>
	</div>
	<div class="form-item wmd-panel-wrap">
		<div class="form-field">
			<div class="doc-editor">
				<textarea id="doc-content" name="doc_content" class="doc-content"></textarea>
			</div>
		</div>
	</div>
