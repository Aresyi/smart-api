		...
		<div class="container" style='width: 90%;'>
			<div class="page">
				<div class="page-inner" id="page-doc-new">
					<div class="doc-wrap">
						<form class="form form-edit-doc" action="/smart-api/message/addMsg" method="post" style='width: 100%;' onsubmit="return checkForm(this);">
							...
							<div class="form-item doc-title-wrap">
								<div class="form-field">
									<input id="doc_title" name="doc_title" class="doc-title" placeholder="文档标题" />
								</div>
							</div>
